...
with open("data/flights.csv", "r", newline="") as fl:
    with open("data/airports.csv", "r", newline="") as ap:
        with open("data/airports_aggregated.csv", "w", newline="") as outfile:
            ...
            for airport in airports:
                ...
                airport_temp["flights_mon"] = flight_counter_mon
                airport_temp["delays_mon"] = delay_counter_mon
                airport_temp["total_delay_mon"] = total_delay_mon

                airport_temp["flights_tue"] = flight_counter_tue
                airport_temp["delays_tue"] = delay_counter_tue
                airport_temp["total_delay_tue"] = total_delay_tue
                        
                airport_temp["flights_wed"] = flight_counter_wed
                airport_temp["delays_wed"] = delay_counter_wed
                airport_temp["total_delay_wed"] = total_delay_wed
                
                airport_temp["flights_thu"] = flight_counter_thu
                airport_temp["delays_thu"] = delay_counter_thu
                airport_temp["total_delay_thu"] = total_delay_thu
                
                airport_temp["flights_fri"] = flight_counter_fri
                airport_temp["delays_fri"] = delay_counter_fri
                airport_temp["total_delay_fri"] = total_delay_fri
                
                airport_temp["flights_sat"] = flight_counter_sat
                airport_temp["delays_sat"] = delay_counter_sat
                airport_temp["total_delay_sat"] = total_delay_sat

                airport_temp["flights_sun"] = flight_counter_sun
                airport_temp["delays_sun"] = delay_counter_sun
                airport_temp["total_delay_sun"] = total_delay_sun
                
                airport_temp["flights_jan"] = flight_counter_jan
                airport_temp["delays_jan"] = delay_counter_jan
                airport_temp["total_delay_jan"] = total_delay_jan

                airport_temp["flights_feb"] = flight_counter_feb
                airport_temp["delays_feb"] = delay_counter_feb
                airport_temp["total_delay_feb"] = total_delay_feb

                airport_temp["flights_mar"] = flight_counter_mar
                airport_temp["delays_mar"] = delay_counter_mar
                airport_temp["total_delay_mar"] = total_delay_mar

                airport_temp["flights_apr"] = flight_counter_apr
                airport_temp["delays_apr"] = delay_counter_apr
                airport_temp["total_delay_apr"] = total_delay_apr

                airport_temp["flights_may"] = flight_counter_may
                airport_temp["delays_may"] = delay_counter_may
                airport_temp["total_delay_may"] = total_delay_may

                airport_temp["flights_jun"] = flight_counter_jun
                airport_temp["delays_jun"] = delay_counter_jun
                airport_temp["total_delay_jun"] = total_delay_jun

                airport_temp["flights_jul"] = flight_counter_jul
                airport_temp["delays_jul"] = delay_counter_jul
                airport_temp["total_delay_jul"] = total_delay_jul

                airport_temp["flights_aug"] = flight_counter_aug
                airport_temp["delays_aug"] = delay_counter_aug
                airport_temp["total_delay_aug"] = total_delay_aug

                airport_temp["flights_sep"] = flight_counter_sep
                airport_temp["delays_sep"] = delay_counter_sep
                airport_temp["total_delay_sep"] = total_delay_sep

                airport_temp["flights_oct"] = flight_counter_oct
                airport_temp["delays_oct"] = delay_counter_oct
                airport_temp["total_delay_oct"] = total_delay_oct

                airport_temp["flights_nov"] = flight_counter_nov
                airport_temp["delays_nov"] = delay_counter_nov
                airport_temp["total_delay_nov"] = total_delay_nov

                airport_temp["flights_dec"] = flight_counter_dec
                airport_temp["delays_dec"] = delay_counter_dec
                airport_temp["total_delay_dec"] = total_delay_dec
